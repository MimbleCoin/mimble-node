...
fn comments() -> HashMap<String, String> {
	...
	retval.insert(
		"[server]".to_string(),
		"
# Generated Server Configuration File for Mimble Node
#
# When running the mimble executable without specifying any command line
...
"
	...
	retval.insert(
		"db_root".to_string(),
		"
#the directory, relative to current, in which the Mimble blockchain
#is stored
"
		.to_string(),
	);
