...
use crate::consensus::MIMBLE_BASE;
...
lazy_static! {
	static ref WIDTH: usize = (MIMBLE_BASE as f64).log(10.0) as usize + 1;
}
...
pub fn amount_to_hr_string(amount: u64, truncate: bool) -> String {
	let amount = (amount as f64 / MIMBLE_BASE as f64) as f64;
